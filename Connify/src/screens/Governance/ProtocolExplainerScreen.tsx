      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.stepCard, { backgroundColor: colors.surfaceContainerLowest, borderColor: colors.outline }]}>
          ...
          <Text style={[styles.stepDescription, { color: colors.onSurfaceVariant }]}>
            When you trigger a Request signal, your phone generates an Ed25519 payload containing your category (Medical, Security, Transport, etc.) and blinded location grid cell.
          </Text>
