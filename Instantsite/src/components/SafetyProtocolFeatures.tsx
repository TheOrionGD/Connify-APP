...
function verifyResponder(nodeId, trustScore) {
  ...
  return (
    <section className="space-y-20 py-6">
      ...
      {/* Hero Header */}
      <div className="relative rounded-3xl bg-[#0f111a] border border-white/10 p-8 sm:p-14 overflow-hidden shadow-2xl">
        {/* Ambient Glows */}
        ...
        <div className="relative z-10 grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4 border-t border-white/10">
              <div>
                <span className="block font-tech font-extrabold text-2xl text-white">0</span>
                <span className="font-mono text-xs text-slate-400">GPS Logs Stored</span>
              </div>
              <div>
                <span className="block font-tech font-extrabold text-2xl text-rose-400">&lt;1.2s</span>
                <span className="font-mono text-xs text-slate-400">Mesh Propagation</span>
              </div>
              <div>
                <span className="block font-tech font-extrabold text-2xl text-emerald-400">100%</span>
                <span className="font-mono text-xs text-slate-400">ZK-Proof Private</span>
              </div>
              <div>
                <span className="block font-tech font-extrabold text-2xl text-cyan-400">BLE + Wi-Fi</span>
                <span className="font-mono text-xs text-slate-400">Offline Mesh</span>
              </div>
            </div>
