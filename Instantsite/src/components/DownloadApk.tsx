...
export default function DownloadApk() {
  ...
  const handleCopyLink = () => {
    navigator.clipboard.writeText('https://connify-green.vercel.app/download');
    setCopiedLink(true);
            ...
            <div className="lg:col-span-5 flex flex-col justify-start">
              ...
              <div className="flex flex-col gap-3 mb-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full mt-2">
                  <button className="w-full sm:w-1/2 flex items-center justify-center gap-2 px-4 py-2.5 bg-white hover:bg-slate-50 text-slate-700 rounded-[1rem] border border-slate-200 shadow-sm hover:-translate-y-0.5 transition-all cursor-pointer">
                    <PlayStoreIcon className="w-5 h-5 shrink-0" />
                    <div className="text-left">
                      <div className="text-slate-500 text-[9px] font-bold uppercase leading-tight">Get it on</div>
                      <div className="font-bold text-[12px] leading-tight text-slate-900">Google Play</div>
                    </div>
                  </button>

                  <button
                    onClick={handleCopyLink}
                    className="w-full sm:w-1/2 flex items-center justify-center gap-2 px-4 py-2.5 bg-rose-50 hover:bg-rose-100 text-rose-700 rounded-[1rem] border border-rose-200 shadow-sm transition-all cursor-pointer font-mono text-xs font-bold"
                  >
                    {copiedLink ? (
                      <>
            ...
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-7 gap-6 lg:gap-8 xl:gap-10 self-start">
              ...
              <div className="md:col-span-3">
                <div className="bg-white rounded-[1.25rem] border border-rose-100 p-5 shadow-xl shadow-rose-100/60 flex flex-col items-center relative h-full">
                  ...
                  <div className="flex items-center gap-1.5 text-slate-700 font-bold mb-4 text-[11px] bg-slate-50 px-3 py-1.5 rounded-full border border-slate-100">
                    <QrCode className="w-3.5 h-3.5 text-rose-600" />
                    Scan with your phone
                  </div>

                  <div className="bg-white p-2.5 rounded-[1rem] shadow-sm border border-slate-100 mb-4 relative">
                    <QRCode value="https://connify-green.vercel.app/download" size={130} level="H" fgColor="#090a0f" />
                  ...
                  <div className="flex items-center justify-center gap-1 w-full pt-3 border-t border-slate-100 text-[9px] text-slate-500 mt-auto">
                    <Lock className="w-3 h-3 shrink-0 text-rose-600" />
              ...
              <div className="md:col-span-4">
                <div className="bg-white rounded-[1.25rem] border border-slate-100 p-6 shadow-xl shadow-slate-200/50 flex flex-col h-full">
                  <h3 className="text-[11px] font-bold text-slate-900 mb-4 flex items-center justify-between">
                    <span className="flex items-center gap-1.5"><Activity className="w-3.5 h-3.5 text-rose-500" /> Release Information</span>
                    <span className="flex items-center gap-1 font-mono text-[9px] text-slate-400 font-normal"><Calendar className="w-3 h-3" /> Updated Today</span>
                  </h3>
                  ...
                  <div className="mt-auto pt-4 flex items-center gap-2.5 border-t border-slate-100">
                    <Github className="w-4 h-4 text-slate-900" />
                    <div>
                      <div className="text-[10px] font-bold text-slate-900">Synced with GitHub Releases</div>
                      <a href="https://github.com/TheOrionGD/Team-Connify-APP/releases" target="_blank" rel="noreferrer" className="text-[9px] font-bold text-rose-600 hover:underline">View on GitHub ↗</a>
                    </div>
                  </div>
                </div>
              </div>
